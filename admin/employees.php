        ...
        if ($do == 'Manage') {
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <caption>Tabla empleado</caption>
                            <thead>
                                <tr>
                                    ...
                                    <ul class="list-inline m-0">
                                        ...
                                        <li class="list-inline-item" data-toggle="tooltip" title="Editar">
                                            <button class="btn btn-success btn-sm rounded-0">
                                                <a href="employees.php?do=Edit&employee_id=<?php
                                                echo $employee['employee_id']; ?>" style="color: white;">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            echo $employee['employee_id']; ?>"
                                                                class="btn btn-danger delete_employee_bttn">
                                                                Eliminar</button>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['employee_fname'])) ?
                                        htmlspecialchars($_POST['employee_fname']) : '' ?>" placeholder="Nombre"
                                        name="employee_fname">
                                    <?php
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['employee_lname'])) ?
                                        htmlspecialchars($_POST['employee_lname']) : '' ?>" placeholder="Apellido"
                                        name="employee_lname">
                                    <?php
                                    if (isset($_POST['add_new_employee'])) {
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['employee_phone'])) ?
                                        htmlspecialchars($_POST['employee_phone']) : '' ?>" placeholder="Teléfono"
                                        name="employee_phone">
                                    <?php
                                    if (isset($_POST['add_new_employee'])) {
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['employee_email'])) ?
                                        htmlspecialchars($_POST['employee_email']) : '' ?>" placeholder="Correo"
                                        name="employee_email">
                                    <?php
                                    if (isset($_POST['add_new_employee'])) {
                    ...
                    if (
                        isset($_POST['add_new_employee']) && $_SERVER['REQUEST_METHOD'] == 'POST' &&
                        $flag_add_employee_form == 0
                    ) {
                        ...
                        try {
                            $stmt = $con->prepare("insert into employees(first_name,last_name,phone_number,email)
                             values(?,?,?,?) ");
                            ...
                            <script type="text/javascript">
                                swal("Nuevo Empleado", "El/La nuev@ emplead@ se ha insertado con éxito.",
                                    "success").then((value) => {
            ...
            $employee_id = (isset($_GET['employee_id']) && is_numeric($_GET['employee_id'])) ?
                ...
                if ($count > 0) {
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            echo $employee['first_name'] ?>" placeholder="Nombre"
                                                name="employee_fname">
                                            <?php
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="employee_lname">Apellido</label>
                                            <input type="text" class="form-control" value="<?php
                                            echo $employee['last_name'] ?>" placeholder="Apellido"
                                                name="employee_lname">
                                            <?php
                                            if (isset($_POST['edit_employee_sbmt'])) {
                                                if (empty(test_input($_POST['employee_lname']))) {
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="employee_phone">Teléfono</label>
                                            <input type="text" class="form-control" value="<?php
                                            echo $employee['phone_number'] ?>" placeholder="Teléfono"
                                                name="employee_phone">
                                            <?php
                                            if (isset($_POST['edit_employee_sbmt'])) {
                                                if (empty(test_input($_POST['employee_phone']))) {
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="employee_email">Correo</label>
                                            <input type="text" class="form-control" value="<?php
                                            echo $employee['email'] ?>" placeholder="Correo" name="employee_email">
                                            <?php
                                            if (isset($_POST['edit_employee_sbmt'])) {
                                                if (empty(test_input($_POST['employee_email']))) {
                                                    ?>
                            ...
                            /*** EDIT EMPLOYEE ***/
                            if (
                                isset($_POST['edit_employee_sbmt']) && $_SERVER['REQUEST_METHOD'] == 'POST'
                                && $flag_edit_employee_form == 0
                            ) {
                                $employee_fname = test_input($_POST['employee_fname']);
                                $employee_lname = $_POST['employee_lname'];
                                ...
                                try {
                                    $stmt = $con->prepare("update employees set first_name = ?, last_name = ?,
                                    ...
                                    <script type="text/javascript">
                                        swal("Emplead@ Actualizado", "El/La emplead@ ha sido actualizada con éxito",
                                            "success").then((value) => {
                                                window.location.replace("employees.php");
                                            });
                                    </script>
