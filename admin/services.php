...
if (
    isset($_SESSION['username_barbershop_Xw211qAAsq4']) &&
    ...
    <div class="container-fluid">
        ...
        if ($do == 'Manage') {
            ...
            service_categories sc where s.category_id = sc.category_id");
            $stmt->execute();
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        <caption>Tabla servicios</caption>
                        <thead>
                            <tr>
                                ...
                                <ul class="list-inline m-0">
                                    ...
                                    <li class="list-inline-item" data-toggle="tooltip" title="Editar">
                                        <button class="btn btn-success btn-sm rounded-0">
                                            <a href="services.php?do=Edit&service_id=<?php
                                            echo $service['service_id']; ?>" style="color: white;">
                                    ...
                                    <li class="list-inline-item" data-toggle="tooltip" title="Eliminar">
                                        <button class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="modal"
                                            data-target="#<?php echo $delete_data; ?>" data-placement="top"><em
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['service_name'])) ?
                                        htmlspecialchars($_POST['service_name']) : '' ?>"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['service_duration']))
                                        ? htmlspecialchars($_POST['service_duration']) : '' ?>"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['service_price']))
                                        ? htmlspecialchars($_POST['service_price']) : '' ?>"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="service_description" style="resize: none;"><?php echo (isset($_POST['service_description'])) ?
                                        htmlspecialchars($_POST['service_description']) : ''; ?></textarea>
                                    <?php
                    ...
                    /*** ADD NEW SERVICE ***/
                    if (
                        isset($_POST['add_new_service']) && $_SERVER['REQUEST_METHOD'] == 'POST' &&
                        $flag_add_service_form == 0
                    ) {
                        ...
                        try {
                            $stmt = $con->prepare("insert into services(service_name,service_description,
                            service_price,service_duration,category_id) values(?,?,?,?,?) ");
                            $stmt->execute(
                                array(
                                    $service_name,
                                    $service_description,
                            ...
                            <script type="text/javascript">
                                swal("Nuevo Servicio", "El nuevo servicio ha sido creado con éxito.",
                                    "success").then((value) => {
            ...
            $service_id = (isset($_GET['service_id']) &&
                is_numeric($_GET['service_id'])) ? intval($_GET['service_id']) : 0;
            ...
            if ($service_id) {
                ...
                if ($count > 0) {
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="services.php?do=Edit&service_id=<?php
                            echo $service_id; ?>">
                                <!-- SERVICE ID -->
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            echo $service['service_duration'] ?>" placeholder="Duración de Servicio"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="service_price">Precio de Servicio($)</label>
                                            <input type="text" class="form-control" value="<?php
                                            echo $service['service_price'] ?>" placeholder="Precio de Servicio"
                                                name="service_price">
                                            <?php
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="service_description">Descripción de Servicio</label>
                                            <textarea class="form-control" name="service_description" style="resize: none;"><?php
                                            echo $service['service_description']; ?></textarea>
                                            <?php
                            ...
                            /*** EDIT SERVICE ***/
                            if (
                                isset($_POST['edit_service_sbmt']) &&
                                $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_edit_service_form == 0
                            ) {
                                ...
                                try {
                                    $stmt = $con->prepare("update services set service_name = ?,
                                     service_description = ?, service_price = ?, service_duration = ?,
                                      category_id = ? where service_id = ? ");
                                    $stmt->execute(
                                        array(
                                            $service_name,
                                            $service_description,
                                    ...
                                    <script type="text/javascript">
                                        swal("Servicio Actualizado",
                                            "Este servicio ha sido actualizado, correctamente",
                                            "success").then((value) => {
                                                window.location.replace("services.php");
                                            });
                                    </script>
