                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto">
                                <em class="bs bs-boy fa-2x text-gray-300"></em>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo countItems("service_id", "services") ?>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <em class="bs bs-scissors-1 fa-2x text-gray-300"></em>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    ...
                                    <div class="col-auto">
                                        <em class="bs bs-man fa-2x text-gray-300"></em>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered tabcontent" id="Upcoming" style="display:table" width="100%"
                                    cellspacing="0">
                                    <caption>Tabla servicio</caption>
                                    <thead>
                                        <tr>
                                            <th>
                                                Hora de inicio
                                                ...
                                                <ul class="list-inline m-0">
                                                    ...
                                                    <li class="list-inline-item" data-toggle="tooltip" title="Cancelar Cita">
                                                        <button class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="modal"
                                                            ...
                                                            <em class="fas fa-calendar-times"></em>
                                                        </button>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="button" data-id="<?php echo $row['appointment_id']; ?>"
                                                                            class="btn btn-danger cancel_appointment_button">Sí, Cancelar</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
